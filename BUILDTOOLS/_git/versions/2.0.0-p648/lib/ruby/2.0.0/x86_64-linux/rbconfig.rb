...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.0.0-p648")
  ...
  CONFIG["configure_args"] = " '--prefix=/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.0.0-p648' '--with-opt-dir=/var/BUILDTOOLS/OPENSSL/debian' '--enable-shared' 'LDFLAGS=-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.0.0-p648/lib ' 'CPPFLAGS=-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.0.0-p648/include '"
  ...
  CONFIG["rubyw_install_name"] = ""
  CONFIG["LIBRUBY_DLDFLAGS"] = "-Wl,-soname,lib$(RUBY_SO_NAME).so.$(MAJOR).$(MINOR) -L/var/BUILDTOOLS/OPENSSL/debian/lib  -Wl,-R/var/BUILDTOOLS/OPENSSL/debian/lib "
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.0.0-p648/include  -I/var/BUILDTOOLS/OPENSSL/debian/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.0.0-p648/lib  -fstack-protector -rdynamic -Wl,-export-dynamic -L/var/BUILDTOOLS/OPENSSL/debian/lib  -Wl,-R/var/BUILDTOOLS/OPENSSL/debian/lib "
