...
module RbConfig
  RUBY_VERSION.start_with?("2.3.") or
    raise "ruby lib version (2.3.8) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "3"
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "459"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.3.8")
  ...
  CONFIG["configure_args"] = " '--prefix=/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.3.8' '--with-opt-dir=/var/BUILDTOOLS/OPENSSL/ubuntu' '--enable-shared' 'LDFLAGS=-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.3.8/lib ' 'CPPFLAGS=-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.3.8/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.3.8"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/var/BUILDTOOLS/OPENSSL/ubuntu/lib  -Wl,-rpath,/var/BUILDTOOLS/OPENSSL/ubuntu/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.3.8/include  -I/var/BUILDTOOLS/OPENSSL/ubuntu/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.3.8/lib  -fstack-protector -rdynamic -Wl,-export-dynamic -L/var/BUILDTOOLS/OPENSSL/ubuntu/lib  -Wl,-rpath,/var/BUILDTOOLS/OPENSSL/ubuntu/lib"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.3.8"
