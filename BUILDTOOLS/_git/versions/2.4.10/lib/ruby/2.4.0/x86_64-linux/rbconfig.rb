...
module RbConfig
  RUBY_VERSION.start_with?("2.4.") or
    raise "ruby lib version (2.4.10) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "4"
  CONFIG["TEENY"] = "10"
  CONFIG["PATCHLEVEL"] = "364"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10")
  ...
  CONFIG["configure_args"] = " '--prefix=/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10' '--enable-shared' 'LDFLAGS=-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10/lib ' 'CPPFLAGS=-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10/lib  -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.4.10/lib  -fstack-protector -rdynamic -Wl,-export-dynamic"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.4.10"
