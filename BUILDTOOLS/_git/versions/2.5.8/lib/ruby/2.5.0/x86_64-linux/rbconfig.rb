...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8")
  ...
  CONFIG["configure_args"] = " '--prefix=/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8' '--enable-shared' 'LDFLAGS=-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8/lib ' 'CPPFLAGS=-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8/lib  -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.5.8/lib  -fstack-protector -rdynamic -Wl,-export-dynamic"
