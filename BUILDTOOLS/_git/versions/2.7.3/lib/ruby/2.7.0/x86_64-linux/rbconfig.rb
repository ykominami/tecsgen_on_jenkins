...
module RbConfig
  RUBY_VERSION.start_with?("2.7.") or
    raise "ruby lib version (2.7.3) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "7"
  CONFIG["TEENY"] = "3"
  CONFIG["PATCHLEVEL"] = "183"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3' '--enable-shared' 'LDFLAGS=-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3/lib ' 'CPPFLAGS=-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3/lib  -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/2.7.3/lib  -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
