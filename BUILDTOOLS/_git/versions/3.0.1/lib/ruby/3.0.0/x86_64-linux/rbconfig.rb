...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1' '--enable-shared' 'LDFLAGS=-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1/lib ' 'CPPFLAGS=-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1/lib  -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["CXXFLAGS"] = ""
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/var/BUILDTOOLS/ANYENV/.anyenv/envs/rbenv/versions/3.0.1/lib  -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
